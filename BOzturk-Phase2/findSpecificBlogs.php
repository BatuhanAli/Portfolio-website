<?php
// to go back to the main blog page
if ($_POST['button'] == "Return"){
    header("Location: Blog.php");
}

// to add a blog basically a shortcut
  ...
  <body>
    ...
    <div id="Content" class="blogs">
        ...
        <form method="POST" action="findSpecificBlogs.php">
            <fieldset>
                <select name="specificDates" for="SpecificDate">
                    ...
                    <?php include('findSpecificDates.php'); ?> <!-- echos out the month year timestamps as options -->
                </select>
      ...
      <section id="blogContainer">
        <?php // echos out all the blogs in the month year timestamp selected
