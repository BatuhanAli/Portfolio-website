    ...
    <div id="Content" class="blogs">
      ...
      <section>
        <form method="POST" action="findSpecificBlogs.php">
            <fieldset>
                <select name="specificDates"> <!-- form which searches for the month you choose -->
                    <option disabled>Select a specific date</option>
                    <?php include('findSpecificDates.php'); ?> <!-- finds and prints all unique month year timestamps as options -->
                </select>
