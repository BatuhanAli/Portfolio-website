<?php
// if the user is already logged in it will go to the add blog page
  session_start();
...
<html>
  ...
  <body>
    ...
    <div id="Content">
        ...
        <form method="POST" action="login.php"> <!-- form for the login which is then checked against the db-->
            <fieldset>
                <legend> Login </legend>
